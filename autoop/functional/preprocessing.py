...
This module provides functions to preprocess features in a dataset.
The primary function, `preprocess_features`, takes a list of features
and applies appropriate transformations.
Functions
---------
preprocess_features(features: List[Feature], dataset: Dataset)
    -> List[Tuple[str, np.ndarray, dict]]
    Preprocesses features in the dataset, returning transformed data
    and metadata.
"""
...
def preprocess_features(
        features: List[Feature], dataset: Dataset) -> List[Tuple[str, np.ndarray, dict]]:
    """
    Preprocess features
    Args:
