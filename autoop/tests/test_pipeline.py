...
from autoop.core.ml.model.regression.regression_models import LinearRegressionModel
from autoop.core.ml.metric import MeanSquaredError

class TestPipeline(unittest.TestCase):
    """
    Unit tests for the Pipeline class,
    focusing on preprocessing, training, and evaluation.
    """

    def setUp(self):
        """Set up a pipeline instance and dataset for testing."""
    ...
    def test_train(self):
        """Test the training process of the pipeline model."""
        self.pipeline._preprocess_features()
        self.pipeline._split_data()
    ...
    def test_evaluate(self):
        """Test the evaluation process of the pipeline model."""
        self.pipeline._preprocess_features()
        self.pipeline._split_data()
        self.pipeline._train()
